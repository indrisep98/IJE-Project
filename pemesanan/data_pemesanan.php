...
<body class="cbp-spmenu-push">
    ...
    <div id="page-wrapper">
      <div class="main-page">
        <div class="tables">
          <h2 class="title1">Data Pemesanan</h2>
...
?>
               <tr> 
                ...
                <td><?php echo $data['kiriman_barang'];?></td> 
                <td>
                        <ul class="bt-list">
                          <a href="edit_pemesanan.php?id_pemesanan=<?php echo $data['id_pemesanan']; ?>" class="hvr-icon-grow-edit">Edit</a>|
                          <a href="hapus_proses.php?id_pemesanan=<?php echo $data['id_pemesanan']; ?>" class="hvr-icon-grow-hapus">Hapus</a>
                        </div>
                      </div>
                    </div>
                  </div>
